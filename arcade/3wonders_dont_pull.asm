...
.14AC:
    lea     (!score_p1 + 4, A5), A0
    movea.l #0x90A388, A1
    bra.w   .14C4

.14BA:
    lea     (!score_p2 + 4, A5), A0
    movea.l #0x90B308, A1
.14C4:
    movea.l #_F046C, A2
    add.w   D1, D1
...
_42208: ;big function that runs when loading a new stage
    lea     0x8000.w, A5
    move.w  #0x00, 0x9157FE.l
.2214:
    move.w  #0x01, D0
    jsr     0x08C0.w
    pea     (.2214, PC)
    ...
    bsr.w   _4295C
    bsr.w   _42942
    subq.b  #1, (!stage_variation, A5)
    move.b  #0x01, (0x8DCB, A5)
.2244:
    moveq   #0x00, D0
    move.l  D0, (0x10, A0)
    move.l  D0, (0x14, A0)
...
.5218:
    ...
    add.w   D1, D0
    lsr.w   #8, D0
    add.b   D0, (!rng_stage + 1, A5)
    move.b  D0, (!rng_stage, A5)
    move.b  (!rng_stage + 1, A5), D0
    rts
...
_57E86: ;drop item from star block?
    move.w  #0x02, (0x10, A0)
    jsr     0x044C.w
    bcs.w   .7EAC
...
_61F3A:
    ...
    ; 061F54 is also rng related... haven't found anything that uses it yet
...
.77B6: d08 0x01, 0x02, 0x03, 0x04, 0x01, 0x02, 0x03, 0x04
.77BE: d08 0x11, 0x12, 0x13, 0x15, 0x11, 0x12, 0x13, 0x15
.77C6: d08 0x07, 0x08, 0x09, 0x0A, 0x0C, 0x07, 0x08, 0x09
.77CE: d08 0x39, 0x3C, 0x3D, 0x3E, 0x39, 0x3C, 0x3D, 0x3E
.77D6: d08 0x16, 0x18, 0x1B, 0x1C, 0x16, 0x18, 0x1B, 0x1C
.77DE: d08 0x1D, 0x1E, 0x20, 0x21, 0x1D, 0x1E, 0x20, 0x21
.77E6: d08 0x24, 0x27, 0x28, 0x29, 0x24, 0x27, 0x28, 0x29
.77EE: d08 0x32, 0x33, 0x35, 0x36, 0x32, 0x33, 0x35, 0x36
.77F6: d08 0x0D, 0x0E, 0x10, 0x0D, 0x0E, 0x10, 0x0D, 0x0E
.77FE: d08 0x2B, 0x2C, 0x2B, 0x2C, 0x2B, 0x2C, 0x2B, 0x2C
.7806: d08 0x2D, 0x2E, 0x2D, 0x2E, 0x2D, 0x2E, 0x2D, 0x2E
.780E: d08 0x3F, 0x40, 0x3F, 0x40, 0x3F, 0x40, 0x3F, 0x40
.7816: d08 0x05, 0x06, 0x05, 0x06, 0x05, 0x06, 0x05, 0x06
.781E: d08 0x2F, 0x30, 0x2F, 0x30, 0x2F, 0x30, 0x2F, 0x30
.7826: d08 0x31, 0x31, 0x31, 0x31, 0x31, 0x31, 0x31, 0x31
.782E: d08 0x37, 0x37, 0x37, 0x37, 0x37, 0x37, 0x37, 0x37

.7836: d08 0x14, 0x3B, 0x19, 0x23, 0x25, 0x0B, 0x1A, 0x22, 0x26, 0x38, 0x17, 0x0F, 0x1F, 0x3A, 0x2A, 0x34
